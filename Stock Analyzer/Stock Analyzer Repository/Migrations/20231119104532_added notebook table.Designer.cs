...
namespace Stock_Analyzer_Repository.Migrations
{
    ...
    [Migration("20231119104532_added notebook table")]
    partial class addednotebooktable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stock_Analyzer_Repository.DataModels.NotebookDataModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Stock_Analyzer_Repository.DataModels.Filter.FilterCriteriaDataModel", b =>
                {
                    b.HasOne("Stock_Analyzer_Repository.DataModels.Filter.FilterDataModel", "Filter")
                        .WithMany("Criterias")
            ...
            modelBuilder.Entity("Stock_Analyzer_Repository.DataModels.Filter.FilterResultDataModel", b =>
                {
                    ...
                    b.HasOne("Stock_Analyzer_Repository.DataModels.Filter.FilterCriteriaDataModel", "FilterCriteria")
                        .WithMany("FilterResults")
